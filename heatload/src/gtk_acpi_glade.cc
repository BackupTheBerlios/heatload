...
{  
   ...
   table2->attach(*label_temp, 1, 2, 0, 1, GTK_SHRINK|GTK_FILL, GTK_SHRINK, 0, 0);
   table2->attach(*label_load, 1, 2, 1, 2, GTK_SHRINK|GTK_FILL, GTK_SHRINK, 0, 0);
   table2->attach(*label_cooling, 3, 4, 0, 1, GTK_SHRINK|GTK_FILL, GTK_SHRINK, 0, 0);
   table2->attach(*label_ac, 3, 4, 1, 2, GTK_SHRINK|GTK_FILL, GTK_SHRINK, 0, 0);
   table2->attach(*label_fan_, 2, 3, 0, 1, GTK_SHRINK|GTK_FILL, GTK_SHRINK, 0, 0);
   table2->attach(*label_ac_, 2, 3, 1, 2, GTK_SHRINK|GTK_FILL, GTK_SHRINK, 0, 0);
   ...
   table3->attach(*frame_label, 0, 1, 1, 2, GTK_FILL, GTK_FILL, 0, 0);
