...
{  
   ...
   table2->attach(*label_bat1_, 0, 1, 3, 4, GTK_FILL, 0, 0, 0);
   table2->attach(*label_ac_, 2, 3, 1, 2, GTK_FILL, 0, 0, 0);
   table2->attach(*label_ac, 3, 4, 1, 2, GTK_FILL, 0, 0, 0);
   table2->attach(*label_bat1, 1, 4, 3, 4, GTK_FILL, 0, 0, 0);
   table2->attach(*label_fan_, 2, 3, 0, 1, GTK_FILL, 0, 0, 0);
   table2->attach(*label_cooling, 3, 4, 0, 1, GTK_FILL, 0, 0, 0);
   table2->attach(*label_load_, 0, 1, 1, 2, GTK_FILL, 0, 0, 0);
   table2->attach(*label_load, 1, 2, 1, 2, GTK_FILL, 0, 0, 0);
