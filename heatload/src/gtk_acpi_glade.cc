// generated 2002/12/17 10:05:33 CET by thoma@Tiger.(none)
...
{  
   ...
   Gtk::Label *label_cpu_throttling_ = manage(new class Gtk::Label("CPU: "));
   ...
   table2->attach(*eventbox_cpu_throttling, 0, 2, 2, 3, GTK_SHRINK|GTK_FILL, GTK_EXPAND|GTK_SHRINK|GTK_FILL, 0, 0);
