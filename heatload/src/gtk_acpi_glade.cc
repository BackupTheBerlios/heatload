...
{  
   ...
   Gtk::Label *label_cpu_throttling_ = manage(new class Gtk::Label("Thro.: "));
   label_cpu_throttling = manage(new class Gtk::Label("label3"));
   
   Gtk::HBox *hbox1 = manage(new class Gtk::HBox(false, 0));
   eventbox_cpu_throttling = manage(new class Gtk::EventBox());
   
   Gtk::Label *label_cpu_performance_ = manage(new class Gtk::Label("Perf."));
   label_cpu_performance = manage(new class Gtk::Label("label3"));
   
   Gtk::HBox *hbox2 = manage(new class Gtk::HBox(false, 0));
   eventbox_cpu_performance = manage(new class Gtk::EventBox());
   ...
   Gtk::EventBox *eventbox_main = manage(new class Gtk::EventBox());
   ...
   label_cpu_throttling_->set_alignment(0,0.5);
   label_cpu_throttling_->set_padding(0,0);
   label_cpu_throttling_->set_justify(GTK_JUSTIFY_CENTER);
   label_cpu_throttling_->set_line_wrap(false);
   label_cpu_throttling->set_alignment(0,0.5);
   label_cpu_throttling->set_padding(0,0);
   label_cpu_throttling->set_justify(GTK_JUSTIFY_CENTER);
   label_cpu_throttling->set_line_wrap(false);
   hbox1->pack_start(*label_cpu_throttling_, false, false, 0);
   hbox1->pack_start(*label_cpu_throttling, false, false, 0);
   _tooltips.set_tip(*eventbox_cpu_throttling, "CPU throttling: 0% means NO throttling or best performance. Can be changed by the context menu (right mouse button).", "");
   eventbox_cpu_throttling->add(*hbox1);
   label_cpu_performance_->set_alignment(0,0.5);
   label_cpu_performance_->set_padding(0,0);
   label_cpu_performance_->set_justify(GTK_JUSTIFY_CENTER);
   label_cpu_performance_->set_line_wrap(false);
   label_cpu_performance->set_alignment(0,0.5);
   label_cpu_performance->set_padding(0,0);
   label_cpu_performance->set_justify(GTK_JUSTIFY_CENTER);
   label_cpu_performance->set_line_wrap(false);
   hbox2->pack_start(*label_cpu_performance_, false, false, 0);
   hbox2->pack_start(*label_cpu_performance, false, false, 0);
   _tooltips.set_tip(*eventbox_cpu_performance, "CPU performance: Can be changed by the context menu (right mouse button).", "");
   eventbox_cpu_performance->add(*hbox2);
   ...
   table2->attach(*eventbox_cpu_throttling, 0, 2, 2, 3, GTK_SHRINK|GTK_FILL, GTK_SHRINK|GTK_FILL, 0, 0);
   table2->attach(*eventbox_cpu_performance, 3, 5, 2, 3, GTK_SHRINK|GTK_FILL, GTK_SHRINK|GTK_FILL, 0, 0);
   ...
   label1->show();
   label_temp->show();
   label_cpu_throttling_->show();
   label_cpu_throttling->show();
   hbox1->show();
   eventbox_cpu_throttling->show();
   label_cpu_performance_->show();
   label_cpu_performance->show();
   hbox2->show();
   eventbox_cpu_performance->show();
   table2->show();
   frame_label->show();
   table3->show();
   eventbox->show();
   ...
   eventbox_main->show();
   gtk_acpi->show();
   eventbox_main->button_press_event.connect(SigC::slot(this, &gtk_acpi_glade::on_eventbox_main_button_press_event));
